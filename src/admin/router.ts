 ...
 * `CollectPage` and `HistoryPage` are this project's own screens so far.
 * Every other sidebar destination still routes to `PlaceholderPage.vue`
 * until a later task builds a real screen for it.
 */
